...
En base a los datos de test, parece que el algorimo M5, es ciertamente mejor que los demás, aunque los resultados no son muy concluyebtes. Por otro lado, en base a los resultados de training, podemos comprar que el algoritmo M5 es mejor que el LM y KNN con pvalues de 0.0039, y 0.0067 frente a estos y que a su mismo tiempo, el algoritmo KNN está por delante del LM, con un valor de p-value de 0.0067.
